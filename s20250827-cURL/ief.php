<?php
/**
 * IEF 近 30 年：每年最後一個交易日 Close / Adj Close、年報酬率、年化報酬率 (CAGR)
...
$ticker  = 'IEF'; // 目標：IEF
$period1 = strtotime('1995-01-01'); // IEF 2002 上市，抓早一點也 OK
$period2 = time();
...
// JSON 輸出
$jsonPath = __DIR__ . '/ief_last_trading_day_30y.json';
$output = [
    'data' => $result,
    'cagr' => [
...
// CSV 輸出
$csvPath = __DIR__ . '/ief_last_trading_day_30y.csv';
$fp = fopen($csvPath, 'w');
